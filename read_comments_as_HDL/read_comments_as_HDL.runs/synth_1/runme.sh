...
HD_PWD='C:/Users/Abhik/Documents/my_vivado_project/read_comments_as_HDL/read_comments_as_HDL.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log read_comments_as_HDL.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source read_comments_as_HDL.tcl
